...
const columns = [
    { id: 'title', label: '제목', minWidth: 200, maxWidth: 200 },
    { id: 'score', label: '트렌드 점수', minWidth: 150, maxWidth: 150 },
    { id: 'sales', label: '판매 점수', minWidth: 100, maxWidth: 100 }
];

const MainPageBookTable = () => {
        ...
        <React.Fragment>
            <Paper
                ...
                sx={{
                    ...
                    borderRadius: '20px',
                    width: '100%', // Set a fixed width or maxWidth as needed
                    maxWidth: '600px',
                    margin: 'auto'
                }}
